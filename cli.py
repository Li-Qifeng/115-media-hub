...
def _build_parser() -> argparse.ArgumentParser:
    ...
    sp_sub.add_argument("--candidate-scan-prefetch-limit", type=int, default=3, help="候选扫描预取数（0-80）")
    sp_sub.add_argument("--candidate-scan-concurrency", type=int, default=1, help="候选扫描并发（1-6）")
    sp_sub.add_argument("--share-scan-concurrency", type=int, default=1, help="分享扫描并发（1-6）")
    sp_sub.add_argument("--share-scan-rate-limit-seconds", type=float, default=1.0, help="分享扫描速率限制（0.05-5s）")
